...
WALLS = []
DETERMINISTIC = False
GAMMA_DECAYS = [0.5,0.75,0.9,1]
EXPLORATION_RATE = [0.1,0.3,0.5,0.75]
EPOCHS = [10000,15000,20000,50000]
...
class Agent:
    ...
    def __init__(self):
        ...
        self.lr = 0.5
        self.exp_rate = EXPLORATION_RATE[3]
        self.decay_gamma = GAMMA_DECAYS[3]
